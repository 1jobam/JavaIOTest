...
public class T15_ObjectStreamTest {
	public static void main(String[] args) {
		...
		Member mem3 = new Member("이몽룔", 40, "강원");
		...
		try {
			...
			// 입력용 스트림 객체 생성
			ObjectInput ois = new ObjectInputStream(new BufferedInputStream(new FileInputStream("e:/D_Other/memObj.bin")));
...
class Member implements Serializable {
	// 자바는 Serializable 인테페이스를 구현한 클래스만 직렬화 할수 있도록 제한하고 있음.
